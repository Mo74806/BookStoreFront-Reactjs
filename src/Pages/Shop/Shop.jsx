...
export default function Shop() {
  ...
  return (
    <div className={` row m-0 ${classes.shop}`}>
      {filterModal && (
        <Modal onClose={showFilterModal}>
          {" "}
          <div
            className={`col-lg-2 col-md-4    align-items-center col-0  d-md-none d-flex flex-column my-5 px-3 ${classes.filters} `}
          >
            <div className="mb-2">
              <FilterOption
                name="Category"
      ...
      <div className="row mx-0">
        ...
        <div className="row  mx-auto d-md-none d-block  py-4  border-gray border-bottom">
        ...
        <div
          className={`col-md-8 col-lg-9  col-12  mr-lg-4     mx-md-auto px-sm-5 px-md-0 mt-md-5   mb-3 `}
        >
          <BookGrid />
